...
\citeonline{xu2018} demonstraram que a combinação de texto de \textit{tweets} com séries históricas de preço melhora a predição de direção em ações do S\&P~500, utilizando um modelo de atenção hierárquico.
% TODO-PROF-B1: buscar e inserir métrica de xu2018 (acurácia/MCC reportada no StockNet)
\citeonline{fischer2018} aplicaram LSTMs (\textit{Long Short-Term Memory}, proposta originalmente por \citeonline{hochreiter1997}) à predição de retornos diários de ações do S\&P~500, reportando resultados superiores ao \textit{buy-and-hold} em períodos específicos.
% TODO-PROF-B1: buscar e inserir métrica de fischer2018 (retorno/Sharpe vs buy-and-hold)
No contexto brasileiro, \citeonline{cavalcante2016} utilizaram análise de sentimento de notícias em português para predição de volatilidade do IBOVESPA,
% TODO-PROF-B1: buscar e inserir métrica de cavalcante2016
e \citeonline{santos2020} aplicaram modelos BERT a textos financeiros da CVM.
% TODO-PROF-B1: buscar e inserir métrica de santos2020 (acurácia/F1 do BERT)
