...
\begin{frame}{Bateria de investigação: 1.435 execuções pré-registradas ($\approx$1.500 com \textit{sanity checks})}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Espaço de busca $=$ 6 células (3 ativos $\times$ 2 horizontes); Bonferroni só reforça o nulo do sentimento e os $|\Delta|=0{,}255$ do preço passam com folga
    \end{itemize}
  \end{columns}
  \vspace{1ex}
...
\begin{frame}{Expanding-window CV: a inversão}
  \begin{columns}[T]
    ...
    \begin{table}
      \footnotesize
      {\footnotesize\itshape AUC médio (5 \textit{folds} $\times$ 5 sementes); $\Delta=$ Transf.$-$XGB(preço), \textbf{não} ablation de sentimento}\\[0.5ex]
      \begin{tabular}{lccc}
        \toprule
        ...
        VALE3 & 0{,}599 & 0{,}635 & {\footnotesize $+$0{,}036, n.s.\ (s.15)} \\
        \midrule
  ...
  \begin{columns}[T]
    ...
    \begin{table}
      ...
      \begin{tabular}{lcccc}
        ...
        VALE3 & 0{,}609 & 0{,}510 & 0{,}667 & {\footnotesize $+$0{,}058, n.s.\ (s.15)} \\
        \midrule
