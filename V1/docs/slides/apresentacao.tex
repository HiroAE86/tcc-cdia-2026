...
\begin{frame}{Pipeline}
  ...
  \begin{itemize}
    ...
    \item \textbf{Risco conhecido:} \textit{forward-fill} de sentimento propaga só o \alert{passado}; a conclusão nula é robusta \alert{à direção do viés} --- se favorece o sentimento, $\Delta=+0{,}003$ é teto otimista; se for contra, o efeito real é ainda menor (risco intradiário no slide 19)
  \end{itemize}
\end{frame}
...
\begin{frame}{O resultado que ``confirmou'' a hipótese}
  ...
  \end{columns}
  \vspace{1ex}
  {\footnotesize Estimativa pontual, 1 janela, 1 semente, sem IC --- refutado nos slides 13--16.}
\end{frame}
...
\begin{frame}{Primeiro confronto: hierarquia de \textit{baselines}}
  ...
  \begin{itemize}
    ...
    \item \alert{AUC mede separabilidade, não retorno} (Lo, 2004; $h=21$ sobreposto infla a autocorrelação). \textbf{Sem evidência de lucratividade líquida:} é momentum/autocorrelação, e o \textit{backtest exploratório} não superou custos/\textit{slippage} (s.19)
  \end{itemize}
  \vspace{0.5ex}
...
\begin{frame}{Expanding-window CV: a inversão}
  \begin{columns}[T]
    ...
    \end{block}
    \alert{\textbf{Na VALE3 o ganho do sentimento nunca é significativo.}}
    \begin{table}
      \footnotesize
      ...
      \begin{tabular}{lccc}
        ...
        VALE3 & 0{,}599 & 0{,}635 & {\footnotesize $+$0{,}036, $p=0{,}194$} \\
        \midrule
  ...
  \begin{columns}[T]
    ...
    \begin{table}
      ...
      \begin{tabular}{lcccc}
        ...
        VALE3 & 0{,}609 & 0{,}510 & 0{,}667 & {\footnotesize $+$0{,}058, $p=0{,}194$} \\
        \midrule
